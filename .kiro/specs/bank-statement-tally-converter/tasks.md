...
- [~] 2. Data models
  - [ ] 2.1 Implement Pydantic v2 models in `app/models.py`
  ...
  - [ ]* 2.2 Write unit tests for `Transaction` model in `tests/test_models.py`
  ...
  - [ ]* 2.3 Write property test for negative amount rejection
...
- [~] 3. XML generator
  - [ ] 3.1 Implement `app/xml_generator.py`
  ...
  - [ ]* 3.2 Write unit tests for XML generator in `tests/test_xml_generator.py`
  ...
  - [ ]* 3.3 Write property test for voucher type selection
...
- [~] 5. Bank statement parsers
  - [ ] 5.1 Implement `app/pipeline/parsers/hdfc.py`
  ...
  - [ ]* 5.5 Write property test for date normalization
    ...
    - _tests/test_properties.py_
  - [ ]* 5.6 Write property test for numeric field cleaning
...
- [~] 6. LangGraph extraction pipeline
  - [ ] 6.1 Implement `app/pipeline/graph.py`
  ...
  - [ ]* 6.2 Write property test for LLM-extracted transactions with invalid dates
    ...
    - _tests/test_properties.py_
  - [ ]* 6.3 Write property test for extracted transactions having required fields
...
- [~] 7. Groq ledger classifier
  - [ ] 7.1 Implement `app/classifier.py`
  ...
  - [ ]* 7.2 Write property test for classification populating all ledger assignments
...
- [~] 8. FastAPI backend
  - [ ] 8.1 Implement `app/main.py` with all endpoints
  ...
  - [ ]* 8.2 Write unit tests for API in `tests/test_api.py`
  ...
  - [ ]* 8.3 Write property test for unique job IDs
    ...
    - _tests/test_properties.py_
  - [ ]* 8.4 Write property test for non-PDF rejection
    ...
    - _tests/test_properties.py_
  - [ ]* 8.5 Write property test for job ready status
...
- [~] 10. Streamlit frontend
  - [ ] 10.1 Implement `frontend/app.py`
